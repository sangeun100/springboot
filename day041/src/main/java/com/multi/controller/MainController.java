...
public class MainController {
	...
	public ModelAndView custaddimpl(ModelAndView mv, CustVO cust) { // 화면과 데이터를 같이 세팅
	...
	public ModelAndView productaddimpl(ModelAndView mv, ProductVO p) { // 화면과 데이터를 같이 세팅
